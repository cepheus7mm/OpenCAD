namespace OpenCAD.Settings.UnitSettingsTests
{
    ...
    public sealed class UnitSettingsTests
    {
        ...
        [DataRow(-Math.PI / 6, "-30° 0' 0.0000\"", AngularType.DegreesMinsSecs, 4u)]
        ...
        [DataRow("-14814.81\"", -1234.5675, LinearType.DecimalInches, 2u)]
        ...
        [DataRow("-30° 0' 0.0000\"", -Math.PI / 6, AngularType.DegreesMinsSecs, 4u)]
        ...
        [DataRow("-33.333333gon", -Math.PI / 6, AngularType.Gradians, 6u)]
