...
namespace OpenCAD.Geometry.Helpers
{
    ...
    public class GeoPointGlyph : OpenCADObject
    {
        ...
        private void BuildSquare(Color color)
        {
            ...
            // Four corners
            var bottomLeft = new Point3D(center.X - _halfSize, center.Y - _halfSize, 0);
            var bottomRight = new Point3D(center.X + _halfSize, center.Y - _halfSize, 0);
            var topRight = new Point3D(center.X + _halfSize, center.Y + _halfSize, 0);
            var topLeft = new Point3D(center.X - _halfSize, center.Y + _halfSize, 0);
        ...
        private void BuildTriangle(Color color)
        {
            ...
            var top = new Point3D(center.X, center.Y + centroidToTop, 0);

            // Bottom vertices
            var bottomLeft = new Point3D(center.X - halfBase, center.Y - centroidToBase, 0);
            var bottomRight = new Point3D(center.X + halfBase, center.Y - centroidToBase, 0);
        ...
        private void BuildDiamond(Color color)
        {
            ...
            var top = new Point3D(center.X, center.Y + _halfSize, 0);
            var right = new Point3D(center.X + _halfSize, center.Y, 0);
            var bottom = new Point3D(center.X, center.Y - _halfSize, 0);
            var left = new Point3D(center.X - _halfSize, center.Y, 0);
        ...
        private void BuildAnchor(Color color)
        {
            ...
            var top = new Point3D(center.X, center.Y + _halfSize, 0);
            var bottomLeft = new Point3D(center.X - _halfSize * 0.7, center.Y - _halfSize * 0.3, 0);
            var bottomRight = new Point3D(center.X + _halfSize * 0.7, center.Y - _halfSize * 0.3, 0);
            
            AddLine(top, bottomLeft, color);
            AddLine(top, bottomRight, color);
            
            // Base line
            var baseLeft = new Point3D(center.X - _halfSize, center.Y - _halfSize, 0);
            var baseRight = new Point3D(center.X + _halfSize, center.Y - _halfSize, 0);
        ...
        private void BuildPerpendicular(Color color)
        {
            ...
            var rightAngleEndLeft = new Point3D(center.X - _halfSize, center.Y + _halfSize, 0);
            var rightAngleEndDown = new Point3D(center.X - _halfSize, center.Y - _halfSize, 0);
            var rightAngleEndRight = new Point3D(center.X + _halfSize, center.Y - _halfSize, 0);
            ...
            //var sq1 = new Point3D(center.X, center.Y, 0); // upper right (at center)
            var sq2 = new Point3D(center.X - _halfSize, center.Y, 0); // upper left
            var sq3 = new Point3D(center.X, center.Y - _halfSize, 0); // lower left
            //var sq4 = new Point3D(center.X, center.Y - _halfSize, 0); // lower right

            AddLine(center, sq2, color);
            AddLine(center, sq3, color);
        }
        ...
        private void BuildHourglass(Color color)
        {
            ...
            // Top triangle
            AddLine(topLeft, center, color);
            AddLine(topRight, center, color);
            AddLine(topLeft, topRight, color);
            
            // Bottom triangle
            AddLine(bottomLeft, center, color);
            AddLine(bottomRight, center, color);
            AddLine(bottomLeft, bottomRight, color);
        }
        ...
        private void BuildExtension(Color color)
        {
            ...
            var start = new Point3D(center.X - _halfSize, center.Y, 0);
            ...
            AddLine(
                new Point3D(center.X - crossSize, center.Y, 0),
                new Point3D(center.X + crossSize, center.Y, 0),
                color);
            AddLine(
                new Point3D(center.X, center.Y - crossSize, 0),
                new Point3D(center.X, center.Y + crossSize, 0),
                color);
        }
